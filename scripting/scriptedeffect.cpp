...
bool ScriptedEffect::init(const QString &effectName, const QString &pathToScript)
{
    ...
    globalObject.setProperty(QStringLiteral("animationTime"),
                             selfObject.property(QStringLiteral("animationTime")));

    globalObject.setProperty(QStringLiteral("displayWidth"),
                             selfObject.property(QStringLiteral("displayWidth")));
    globalObject.setProperty(QStringLiteral("displayHeight"),
                             selfObject.property(QStringLiteral("displayHeight")));

    globalObject.setProperty(QStringLiteral("registerShortcut"),
                             selfObject.property(QStringLiteral("registerShortcut")));
    globalObject.setProperty(QStringLiteral("registerScreenEdge"),
                             selfObject.property(QStringLiteral("registerScreenEdge")));
    globalObject.setProperty(QStringLiteral("registerTouchScreenEdge"),
                             selfObject.property(QStringLiteral("registerTouchScreenEdge")));
    globalObject.setProperty(QStringLiteral("unregisterScreenEdge"),
                             selfObject.property(QStringLiteral("unregisterScreenEdge")));
    globalObject.setProperty(QStringLiteral("unregisterTouchScreenEdge"),
                             selfObject.property(QStringLiteral("unregisterTouchScreenEdge")));

    globalObject.setProperty(QStringLiteral("animate"),
                             selfObject.property(QStringLiteral("animate")));
    globalObject.setProperty(QStringLiteral("set"),
                             selfObject.property(QStringLiteral("set")));
    globalObject.setProperty(QStringLiteral("retarget"),
                             selfObject.property(QStringLiteral("retarget")));
    globalObject.setProperty(QStringLiteral("redirect"),
                             selfObject.property(QStringLiteral("redirect")));
    globalObject.setProperty(QStringLiteral("complete"),
                             selfObject.property(QStringLiteral("complete")));
    globalObject.setProperty(QStringLiteral("cancel"),
                             selfObject.property(QStringLiteral("cancel")));
